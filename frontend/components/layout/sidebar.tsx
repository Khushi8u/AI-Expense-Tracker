    ...
    >
        ...
        <AnimatePresence>
          {!collapsed && (
            ...
            >
              ...
              <span className="font-bold text-foreground text-sm">ExpenseAI</span>
            </motion.div>
          )}
        </AnimatePresence>
        {collapsed && (
      ...
      <div className="p-3 border-t border-border space-y-1">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-red-500/70 hover:text-red-500 hover:bg-red-500/10 transition-all duration-200"
        >
